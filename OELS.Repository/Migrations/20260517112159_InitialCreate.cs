    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "Kangaroo 476"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Thumbnail_Url = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LessonProgress_Percent", "[CompletedPercent] >= 0 AND [CompletedPercent] <= 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassScore = table.Column<int>(type: "int", nullable: false, defaultValue: 70),
                    LimitTimeSec = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_quiz_answers_quiz_options_SelectedOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lesson_progresses_UserId",
                table: "lesson_progresses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_quiz_answers_SelectedOptionId",
                table: "quiz_answers",
